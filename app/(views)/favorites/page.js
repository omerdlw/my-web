...
// Favori film, dizi ve oyun ID'leri
const FAVORITE_IDS = {
  movies: [
    157336, // Interstellar
    769, // Goodfellas
  ...
  games: [
    "the-last-of-us", // RAWG slug
    "call-of-duty-modern-warfare", // RAWG slug
    "alan-wake-2", // RAWG slug
  ],
};
...
export default function FavoritesPage() {
  ...
  if (loading) {
    return <Loading text={"Loading favorites"} fullScreen />;
  }
      ...
      {sectionsToRender.map((section) => {
        ...
        return (
          <div
            ...
            className="w-full h-[calc(100vh-5rem)] absolute top-0 left-0 right-0 bottom-0"
          >
            <div className="w-full h-full flex items-center justify-center gap-4 px-10">
              {data.slice(0, 3).map((item, index) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`relative h-[80vh] flex-1 max-w-[550px] rounded-[30px] overflow-hidden transition-all duration-700 ease-out border border-black/10 dark:border-white/10 ${
                      isHovered
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-8 text-white">
                      <h3
                        className={`text-5xl font-black mb-6 tracking-tight drop-shadow-2xl line-clamp-2 transition-all duration-500 ${
                      ...
                      >
                        <div className="flex items-center gap-4 text-sm">
                          {rating && (
                            <div className="flex items-center gap-2 px-3 py-1.5 bg-yellow-500/20 rounded-full backdrop-blur-sm border border-yellow-500/30">
                        ...
                        {!item.isGame && (
                          <Link
                            ...
                            className="flex items-center gap-2 p-4 bg-skin-primary text-white rounded-[20px] font-semibold text-sm hover:opacity-90 active:scale-95 transition-all shadow-lg"
                          >
