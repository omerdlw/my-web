...
function FormField({
  ...
  return (
    <div className="w-full">
      ...
      {!error && helpText && (
        <p id={`${id}-help`} className="mt-1 text-sm ">
          {helpText}
        </p>
      )}
    </div>
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="mb-8">
        ...
        <p className="">Write and publish your thoughts, stories, and ideas</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <div className="flex items-center gap-4 pt-4">
          ...
          <button
            ...
            onClick={handleReset}
            disabled={isSubmitting || submitSuccess}
            className="px-8 py-3 border rounded-xl font-medium active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          >
            Reset
          </button>
          ...
          <button
            ...
            className="px-8 py-3 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
        </div>
