...
export default function ControlsButton({
  ...
  if (icon && !text) {
    return (
      <div
        className="size-[60px] center cursor-pointer rounded-3xl backdrop-blur-xl overflow-hidden bg-white/60 dark:bg-black/20 border border-black/10 dark:border-white/10 p-1"
        onClick={onClick}
      >
  ...
  return (
    <div
      className="h-[60px] center cursor-pointer rounded-3xl backdrop-blur-xl overflow-hidden bg-white/60 dark:bg-black/20 border border-black/10 dark:border-white/10 p-1"
      onClick={onClick}
    >
